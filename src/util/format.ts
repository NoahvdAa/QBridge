// Taken from https://github.com/flasd/whatsapp-formatting/pull/14, which is licensed under the MIT License
...
export function replaceAll(string: string, strReplace: string, strWith: string): string {
