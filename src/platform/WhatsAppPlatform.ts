...
export class WhatsAppPlatform {
    ...
    private async bootstrap(): Promise<void> {
        ...
        this.client.on('message', (msg: WhatsAppMessage) => this.taskQueue.addAndProcess(async () => {
        ...
        this.client.once('ready', () => console.log(`Logged in as ${this.client.info.wid.user}!`));
    }
